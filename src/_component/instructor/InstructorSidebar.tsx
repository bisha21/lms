...
import { BookOpen, Home, LayoutDashboard, LogOut, Megaphone, Users, Wallet, X } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 pt-5">
          ...
          <div className="min-w-0">
            ...
            <span className="inline-flex items-center rounded-full bg-palette-1-soft px-2 py-0.5 text-[10px] font-semibold text-brand">
              Instructor Studio
            </span>
          </div>
        </div>
